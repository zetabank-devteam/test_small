...
int main(int argc, char** argv){
  ...
  transformStamped2.transform.translation.x = 5.7;
  transformStamped2.transform.translation.y = -2.1;
  ...
  transformStamped3.transform.translation.x = 7.9;
  transformStamped3.transform.translation.y = 1.3;
  ...
  transformStamped4.transform.translation.y = 2.8;
